...
/**
 * Title: Archives
 * Slug: solar-power-energy/archive
 * Categories: solar-power-energy, archive
 */
?>
...
<h3 class="wp-block-heading has-text-align-center has-heading-color has-text-color has-link-color"><?php esc_html_e('Sorry, no post exist...','solar-power-energy'); ?></h3>
<!-- /wp:heading -->
