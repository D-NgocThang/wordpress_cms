 ...
 * Slug: solar-power-energy/blog-right-sidebar
 * Categories: solar-power-energy, blog-right-sidebar
 */
?>
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('Sorry, no post exist...','solar-power-energy'); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-column sidebar-col" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"solar-power-energy","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->