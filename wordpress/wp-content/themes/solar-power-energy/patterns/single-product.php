 ...
 * Slug: solar-power-energy/single-product
 * Categories: solar-power-energy, single-product
 */
?>
...
<h2 class="wp-block-heading has-text-align-left has-large-font-size" style="margin-top:1rem;margin-bottom:1rem"><?php esc_html_e('Related Products','solar-power-energy'); ?></h2>
<!-- /wp:heading -->
